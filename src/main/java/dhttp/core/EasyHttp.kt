...
import dhttp.delegate.LambdaDelegate
import dhttp.http.HttpFile
import dhttp.http.HttpHeader
import dhttp.http.TYPE
import dhttp.parser.JsonParser
import dhttp.parser.Parser
import dhttp.service.RequestManager
            ...
            TYPE.METHOD_POST ->
                if (json != null) {
                    ...
                    when (paramsType) {
                        ...
                        Params.LIST_FILE -> RequestManager.goFile<T>(
                            client,
                            url,
                            head,
                            params.data,
            ...
            TYPE.METHOD_POST ->
                if (json != null) {
                    ...
                    when (paramsType) {
                        ...
                        Params.LIST_FILE -> RequestManager.rxFile<T>(
                            client,
                            url,
                            head,
                            params.data,
