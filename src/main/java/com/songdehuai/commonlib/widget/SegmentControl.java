 ...
 *
 * @author songdehuai
 * @ClassName: com.jiubaisoft.nw.widget.
 * @date 2017/6/29 11:14
 */
public class SegmentControl extends View {
    ...
    public SegmentControl(@NonNull Context context) {
        this(context, null);
    }

    public SegmentControl(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SegmentControl(@NonNull Context context, AttributeSet attrs, int defStyle) {
